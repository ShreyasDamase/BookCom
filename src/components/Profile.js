...
export default function Profile() {
    ...
    useEffect(() => {
        async function fetchUser() {
            const url = 'http://ec2-3-7-254-228.ap-south-1.compute.amazonaws.com:8080/Bookcom/user/details';
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const url = 'http://ec2-3-7-254-228.ap-south-1.compute.amazonaws.com:8080/Bookcom/user/update';
        const token = await session.getToken();

...
export default function Checkout() {
    ...
    async function fetchAllBooks() {
        const url = 'http://ec2-3-7-254-228.ap-south-1.compute.amazonaws.com:8080/Bookcom/orders/getOrderBooks';
    ...
    async function deleteBook(bookId) {
        const url = `http://ec2-3-7-254-228.ap-south-1.compute.amazonaws.com:8080/Bookcom/orders/deleteOrder?id=${bookId}`;
        const jwt_token = await session.getToken();

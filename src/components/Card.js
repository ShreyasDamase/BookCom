...
function Card() {
  ...
  async function getCategory() {
    ...
    try {
      const response = await axios.get('http://ec2-3-7-254-228.ap-south-1.compute.amazonaws.com:8080/Bookcom/book/getCategory', {
        headers: {
  ...
  useEffect(() => {
    async function fetchImage() {
      const url = 'http://ec2-3-7-254-228.ap-south-1.compute.amazonaws.com:8080/Bookcom/book/getImage';
  ...
  const handleFormSubmit = async (e) => {
    e.preventDefault();
    const url = selectedBook ? `http://ec2-3-7-254-228.ap-south-1.compute.amazonaws.com:8080/Bookcom/book/update` : 'http://ec2-3-7-254-228.ap-south-1.compute.amazonaws.com:8080/Bookcom/book/create';
    const jwt_token = await session.getToken();
  ...
  const deleteBook = async (bookId) => {
    const url = `http://ec2-3-7-254-228.ap-south-1.compute.amazonaws.com:8080/Bookcom/book/delete?id=${bookId}`;
    const jwt_token = await session.getToken();
    axios

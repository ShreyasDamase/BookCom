...
function Book() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('http://ec2-3-7-254-228.ap-south-1.compute.amazonaws.com:8080/Bookcom/book/create', data, {
                headers: {
    ...
    return (
        ...
        <section className="flex flex-col w-full h-full p-1 overflow-auto">
          <label htmlFor="frontimage" className="text-base leading-7 text-blueGray-500 mb-5">Add Front Cover</label>
          <input type="file" onChange={handleFrontImageChange} />
        </section>
        <section className="flex flex-col w-full h-full p-1 overflow-auto">
          <label htmlFor="backimage" className="text-base leading-7 text-blueGray-500 mb-5">Add Back Cover</label>

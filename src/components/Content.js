...
export default function Content() {
  ...
  async function getDescription(book) {
    ...
    try {
      const response = await axios.post('http://ec2-3-7-254-228.ap-south-1.compute.amazonaws.com:8080/Bookcom/book/getDescription', { "bookId": book }, {
        headers: {
  ...
  useEffect(() => {
    async function fetchImage() {
      const url = 'http://ec2-3-7-254-228.ap-south-1.compute.amazonaws.com:8080/Bookcom/book/getAllImages';
  ...
  const OrderBook = async (bookId) => {
    ...
    data['bookid'] = bookId;
    const url = `http://ec2-3-7-254-228.ap-south-1.compute.amazonaws.com:8080/Bookcom/orders/create`;
    const jwt_token = await session.getToken();
    axios
          ...
          <div className="modal-content bg-gray-800 p-6 rounded-lg max-w-lg mx-auto relative flex">
            ...
            <div className="flex">
              <img
                ...
                alt="Book Cover"
                className="w-48 h-64 mt-11 object-cover rounded-lg"
              />
              <div className="ml-6">
